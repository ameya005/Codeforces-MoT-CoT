...
import wandb
import glob
from klsft import KLSFTTrainer
...
def main():
    ...
    # KL regularization
    ap.add_argument("--kl_coef", type=float, default=0.0, help="Weight of KL(student||ref)")
    ap.add_argument("--kl_ref_model_id", type=str, default=None,
                    help="Reference model (defaults to --model_id if None)")
    ap.add_argument("--kl_ref_8bit", action="store_true",
                    help="Load reference model in 8-bit to save memory")
    ap.add_argument("--kl_start_step", type=int, default=0,
                   help="Start applying KL after this global step")
    ap.add_argument("--kl_t", type=float, default=1.0, help="Temperature for KL")
    ...
    trainer = KLSFTTrainer(
         ...
         kl_ref_model_id=(args.kl_ref_model_id or args.model_id),
         kl_ref_8bit=args.kl_ref_8bit,
